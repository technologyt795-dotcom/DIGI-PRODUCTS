            ...
            <div className="relative -mt-10 mb-6">
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-indigo-600 font-bold tracking-widest uppercase">كود الخصم الحصري</span>
                </div>
                ...
                <div className="mt-3 overflow-hidden h-5">
                   <p className={`text-sm font-bold transition-all duration-300 ${copied ? 'text-green-600 -translate-y-0' : 'text-indigo-400'}`}>
                    {copied ? '✅ تم النسخ! استخدمه عند الدفع' : 'انقر للنسخ والحصول على الخصم'}
                  </p>
                </div>
              </button>
            </div>
