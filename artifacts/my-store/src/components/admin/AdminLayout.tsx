...
import { LayoutGrid, Package, LogOut, ExternalLink, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-muted/30 text-foreground font-sans" dir="rtl">
      <aside className="md:w-64 shrink-0 border-b md:border-b-0 md:border-l border-border bg-background flex md:flex-col">
        <div className="flex items-center gap-2 px-6 py-5 border-b border-border hidden md:flex">
          <div className="h-9 w-9 rounded-lg bg-primary text-secondary flex items-center justify-center">
            <ShoppingBag className="h-5 w-5" />
          </div>
          <div className="flex flex-col leading-none">
            <span className="font-bold text-primary">My Store</span>
            <span className="text-[10px] text-muted-foreground uppercase tracking-wider">لوحة التحكم</span>
          </div>
        </div>
