...
export default function AdminSettings() {
  ...
  const [activeTheme, setActiveTheme] =
    useState<StoreSettingsUpdateActiveTheme>("classic");
  ...
  const [paymentMastercardEnabled, setPaymentMastercardEnabled] =
    useState(true);
  ...
  useEffect(() => {
    if (settings) {
      ...
      setActiveTheme(
        (settings.activeTheme as StoreSettingsUpdateActiveTheme) || "classic",
      );
      ...
      setNavbarColorsEnabled(
        !!(settings.navbarBgColor || settings.navbarTextColor),
      );
      setDrawerBgColor(settings.drawerBgColor ?? null);
      setDrawerTextColor(settings.drawerTextColor ?? null);
      setDrawerColorsEnabled(
        !!(settings.drawerBgColor || settings.drawerTextColor),
      );
      ...
      setFooterColorsEnabled(
        !!(settings.footerBgColor || settings.footerTextColor),
      );
      setPaymentVisaEnabled((settings as any).paymentVisaEnabled ?? true);
      setPaymentMastercardEnabled(
        (settings as any).paymentMastercardEnabled ?? true,
      );
      setPaymentMadaEnabled((settings as any).paymentMadaEnabled ?? true);
      setPaymentApplePayEnabled(
        (settings as any).paymentApplePayEnabled ?? false,
      );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            إدارة مظهر المتجر ومعلوماته الأساسية
          </p>
        </div>
        <Button
          onClick={handleSave}
        ...
        <TabsContent value="appearance" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                قم برفع الشعار الذي سيظهر في أعلى المتجر
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ImageUploadField
                ...
                onChange={(imgs) =>
                  setLogoUrl(imgs.length > 0 ? imgs[imgs.length - 1] : null)
                }
                label="الشعار"
              />
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {themes.map((theme) => (
                  ...
                  >
                    <div
                      className={cn(
                        "h-32 w-full rounded-md border flex flex-col mb-4 overflow-hidden",
                        theme.preview,
                      )}
                    >
                      <div className="h-8 border-b border-inherit flex items-center px-2 gap-2 opacity-50">
                        <div
                          className={cn("h-3 w-3 rounded-full", theme.primary)}
                        ></div>
                        <div
                          className={cn("h-3 w-12 rounded", theme.secondary)}
                        ></div>
                      </div>
                      <div className="flex-1 p-3 flex gap-2">
                        <div
                          className={cn(
                            "flex-1 rounded-sm opacity-20",
                            theme.primary,
                          )}
                        ></div>
                        <div
                          className={cn(
                            "w-1/3 rounded-sm opacity-20",
                            theme.secondary,
                          )}
                        ></div>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        value={navbarBgColor || ""}
                        onChange={(e) =>
                          setNavbarBgColor(e.target.value || null)
                        }
                    ...
                    >
                      <span style={{ color: navbarTextColor || undefined }}>
                        معاينة الشريط
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNavbarTextColor(e.target.value || null)
                        }
                    ...
                    <div
                      ...
                      style={{
                        background: navbarBgColor || undefined,
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    تخصيص لون خلفية ونصوص نافذة التنقل على الجوال
                  </CardDescription>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        value={drawerBgColor || ""}
                        onChange={(e) =>
                          setDrawerBgColor(e.target.value || null)
                        }
                        placeholder="مثال: #ffffff"
                        dir="ltr"
                        className="text-left font-mono text-sm"
                    ...
                    >
                      <span style={{ color: drawerTextColor || undefined }}>
                        معاينة الخلفية
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setDrawerTextColor(e.target.value || null)
                        }
                    ...
                    <div
                      className="h-10 rounded-md border border-border flex items-center justify-center text-xs font-medium"
                      style={{
                        background: drawerBgColor || undefined,
                        color: drawerTextColor || undefined,
                      }}
                    >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                صورة تظهر خلف نص القسم الرئيسي في الصفحة الرئيسية — الحجم الموصى
                به: <strong>1920 × 1080 px</strong>
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ImageUploadField
                ...
                onChange={(imgs) =>
                  setHeroBgImage(imgs.length > 0 ? imgs[imgs.length - 1] : null)
                }
                label="صورة الخلفية"
              />
              {heroBgImage && (
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    تخصيص ألوان الفوتر وحجم التبادد الداخلي
                  </CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        value={footerBgColor || ""}
                        onChange={(e) =>
                          setFooterBgColor(e.target.value || null)
                        }
                        placeholder="مثال: #0f172a"
                        dir="ltr"
                        className="text-left font-mono text-sm"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFooterTextColor(e.target.value || null)
                        }
                        placeholder="مثال: #ffffff"
                        dir="ltr"
                        className="text-left font-mono text-sm"
                      ...
                      {footerTextColor && (
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => setFooterTextColor(null)}
                          className="shrink-0 text-muted-foreground hover:text-destructive"
                        >
                          حذف
                        </Button>
              ...
              <div
                ...
                style={{
                  background: footerColorsEnabled
                    ? footerBgColor || "#0f172a"
                    : "#0f172a",
                  color: footerColorsEnabled
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                فعّل فقط وسائل الدفع التي تقبلها فعلاً — ستظهر شعاراتها في أسفل
                المتجر
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {[
                  {
                    key: "visa",
                    label: "Visa",
                    description: "بطاقات فيزا الائتمانية والمدفوعة مسبقاً",
                    checked: paymentVisaEnabled,
                    onChange: setPaymentVisaEnabled,
                    badge: (
                  ...
                  },
                  {
                    key: "mastercard",
                    label: "Mastercard",
                    description: "بطاقات ماستركارد الائتمانية",
                    checked: paymentMastercardEnabled,
                    onChange: setPaymentMastercardEnabled,
                    badge: (
                      <span className="inline-flex items-center justify-center bg-white border rounded px-2 py-0.5 h-7 shadow-sm">
                        <svg
                          viewBox="0 0 38 24"
                        ...
                        >
                          ...
                          <path
                            d="M19 5.27A10 10 0 0 1 23.73 12 10 10 0 0 1 19 18.73 10 10 0 0 1 14.27 12 10 10 0 0 1 19 5.27Z"
                            fill="#FF5F00"
                          />
                        </svg>
                      </span>
                  ...
                  },
                  {
                    key: "mada",
                    label: "مدى (Mada)",
                    description: "البطاقات المصرفية السعودية المحلية",
                    checked: paymentMadaEnabled,
                    onChange: setPaymentMadaEnabled,
                    badge: (
                      <span className="inline-flex items-center justify-center bg-white border rounded px-2 py-0.5 h-7 shadow-sm">
                        <svg
                          viewBox="0 0 86 28"
                  ...
                  },
                  {
                    ...
                    label: "Apple Pay",
                    description:
                      "الدفع عبر Apple Pay (يتطلب إعداداً خاصاً مع Moyasar)",
                    checked: paymentApplePayEnabled,
                    onChange: setPaymentApplePayEnabled,
                    badge: (
                  ...
                  },
                  {
                    key: "stcpay",
                    label: "STC Pay",
                    description: "المحفظة الرقمية من STC",
                    checked: paymentStcPayEnabled,
                    onChange: setPaymentStcPayEnabled,
                    badge: (
                      <span className="inline-flex items-center justify-center bg-white border rounded px-2 py-0.5 h-7 shadow-sm">
                        <svg
                          viewBox="0 0 54 20"
                  ...
                  ({ key, label, description, checked, onChange, badge }) => (
                    <div
                      key={key}
        ...
        <TabsContent value="info" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                تظهر هذه المعلومات للعملاء في واجهة المتجر
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                هذا النص يظهر للعملاء في صفحة سياسة الاسترجاع — اتركه فارغاً
                لإخفاء الصفحة من الفوتر
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
        ...
        <TabsContent value="shipping" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                تحديد تكلفة الشحن وشروط الشحن المجاني
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2 md:w-1/2">
                <Label htmlFor="flatShippingRate">
                  تكلفة الشحن الثابتة (ريال)
                </Label>
                <Input
                  id="flatShippingRate"
                  type="number"
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/20">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    تقديم شحن مجاني للطلبات التي تتجاوز قيمة معينة
                  </p>
                </div>
                <Switch
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/20">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    إذا تم التفعيل، لن يتم إضافة الضريبة عند الدفع
                  </p>
                </div>
                <Switch
        ...
        <TabsContent value="social" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                تظهر روابط هذه الحسابات في أسفل المتجر
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
